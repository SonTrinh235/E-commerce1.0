    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/meats' element={<ShopCategory banner={meat_banner} category="Meats"/>}/>
          <Route path='/vegs' element={<ShopCategory banner={veg_banner} category="Vegetables"/>}/>
          <Route path='/others' element={<ShopCategory banner={others_banner} category="Others"/>}/>
          <Route path='/all-products' element={<ShopCategory banner={all_banner} category="Products"/>} />
